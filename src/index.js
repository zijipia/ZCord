...
// const { Ex_Guild, Ex_Channel, Ex_Message, Ex_User, Ex_Interaction } = require("./structures");

const { checkPayload, get_Channel, get_Guild, get_User, get_Message, get_DMChannel, Attachment } = require("./utils");
...
class Client extends EventEmitter {
	...
	// extendGuild = (g) => Ex_Guild(g, this);
	// extendChannel = (c) => Ex_Channel(c, this);
	// // extendMessage = (m) => Ex_Message(m, this);
	// extendUser = (u) => Ex_User(u, this);
	// extendInteraction = (i) => Ex_Interaction(i, this);
